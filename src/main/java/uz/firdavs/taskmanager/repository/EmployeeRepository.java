...
public interface EmployeeRepository extends BaseRepository<Employee, Integer> {
    ...
    @Query(nativeQuery = true,
            value = " select a.wish_id,w.\"name\" as wish_name,a.created_user_id, u.fio as created_user_name, " +
    ...
    List<EmployeesProjection> selectEmployees(@Param("empName") String empName,@Param("technology_part_id") String technology_part_id,@Param("technologyName") String technologyName,@Param("wish_id") String wish_id,@Param("grade_id") String grade_id);
...
//    multiselect filtr select
    @Query(nativeQuery = true,
            value = " select a.wish_id,w.\"name\" as wish_name,a.created_user_id, u.fio as created_user_name, " +
                    ...
                    "cast(jsonb_agg(g.name) as text)  as grades,  " +
                    "cast(jsonb_agg(g.id) as text)  as grade_ids ,   " +
                    "ep.projects,ep.projects_id from employee a " +
                    "left join users u on u.id = a.created_user_id  " +
                    "left join employee_technology et on a.id = et.employee_id  " +
                    "left join technology_grade g on g.id = et.grade_id " +
                    "left join department d on d.id = a.department_id  " +
                    ...
                    "  group by w.\"name\",u.fio,a.id ,a.name,d.name ,d.id,t.technology_part_id,tp.name ,ep.projects,ep.projects_id " +
                    "having cast(jsonb_agg(lower(t.name)) as text) like '%'||lower(:technologyName)||'%' order by a.id desc")
    List<EmployeesProjection> selectEmployees(@Param("empName") String empName,@Param("technology_part_id") String technology_part_id,@Param("technologyName") String technologyName,@Param("wish_id") String wish_id,@Param("intList") List<Integer> intList,@Param("grade_id") String grade_id);
...
//    333.multiselect filtr for project select
    ...
    @Query(nativeQuery = true,
            value = "select a.wish_id,w.\"name\" as wish_name,a.created_user_id, u.fio as created_user_name," +
                    ...
                    "cast(jsonb_agg(t.id) as text)  as skillsId , " +
                    "ep.projects, ep.projects_id " +
                    "from employee a left join users u on u.id = a.created_user_id " +
                    "left join employee_technology et on a.id = et.employee_id " +
                    "left join technology_grade g on g.id = et.grade_id " +
                    "left join department d on d.id = a.department_id  " +
                    "left join technology t on t.id = et.technology_id  " +
    ...
    List<EmployeesProjection> selectEmployees(Integer empId, @Param("empName") String empName,@Param("technology_part_id") String technology_part_id,@Param("grade_id") String grade_id);
