...
public class ProjectController {
    ...
    public ResponseEntity<ResponseDto<?>> createRow(@RequestBody NameRq req){
        return ResponseEntity.ok(service.createRow(req));
    }
    @PutMapping(value = "/{id}")
    @Operation(summary = "edit row by id")
    public ResponseEntity<ResponseDto<?>> editRowById(@RequestBody NameRq req, @PathVariable Integer id){
